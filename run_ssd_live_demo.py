...
model_path = 'models/car_frontback/20201118/mb2-ssd-lite-Epoch-90-Loss-1.455.pth'
label_path = 'models/car_frontback/car-frontback-labels.txt'
video_path = 'sample_data/well-D_data.mp4'
